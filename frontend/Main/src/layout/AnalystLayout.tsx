            ...
            >
                <div className="h-16 flex items-center justify-center border-b border-gray-200 dark:border-gray-800 px-4">
                    <Link to="/analyst" className="flex items-center gap-2">
                        <BrandLogo compact={!sidebarOpen} markClassName="h-10 w-10" />
                    </Link>
                </div>
            ...
            <div className="flex-1 flex flex-col min-h-screen">
                    ...
                    <div className="flex items-center justify-between px-6 py-3 gap-4">
                        <div className="flex items-center gap-4">
                            {user?.role === 'ADMIN' && (
                                <Link
                                    to="/admin"
                                    className="inline-flex items-center gap-2 px-3 py-1.5 bg-brand-50 text-brand-700 dark:bg-brand-500/10 dark:text-brand-300 rounded-lg hover:bg-brand-100 dark:hover:bg-brand-500/20 transition-colors text-sm font-medium"
                                >
                ...
                <footer className="h-12 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 flex items-center justify-center">
                    <p className="text-sm text-gray-500">
                        &copy; {new Date().getFullYear()} Irys Store Analytics. All rights reserved.
                    </p>
                </footer>
            </div>
        </div>
