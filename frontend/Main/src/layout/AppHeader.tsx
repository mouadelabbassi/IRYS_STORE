...
const AppHeader: React.FC = () => {
    ...
    return (
        <header className="sticky top-0 flex w-full bg-white/85 backdrop-blur-xl border-brand-100 z-99999 dark:border-white/8 dark:bg-gray-900/90 lg:border-b">
            <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
                <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-brand-100 dark:border-white/8 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
                    <button
