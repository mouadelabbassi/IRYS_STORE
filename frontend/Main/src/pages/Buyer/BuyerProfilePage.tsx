                        ...
                        <div className="mb-6">
                            ...
                            {isEditing ? (
                                <input
                                    ...
                                    className="w-full px-4 py-3 bg-gray-100 dark:bg-gray-800 border-0 rounded-lg text-gray-900 dark:text-white focus:ring-2 focus:ring-brand-500"
                                    required
                                />
                            ) : (
                        ...
                        <div className="mb-8">
                            ...
                            {isEditing ? (
                                <textarea
                                    ...
                                    rows={3}
                                    className="w-full px-4 py-3 bg-gray-100 dark:bg-gray-800 border-0 rounded-lg text-gray-900 dark:text-white focus:ring-2 focus:ring-brand-500 resize-none"
                                />
                            ) : (
                                <p className="text-gray-900 dark:text-white py-3">
                            ...
                            {isEditing ? (
                                <div className="flex gap-3">
                                    ...
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className="px-6 py-2.5 bg-brand-600 text-white rounded-lg hover:bg-brand-700 disabled:opacity-50 transition-colors"
                                    >
