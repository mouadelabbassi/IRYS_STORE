...
const SellerStockManagement: React.FC = () => {
    ...
    const fetchDashboard = async () => {
        try {
            ...
            const response = await axios.get('/api/seller/stock/dashboard', {
    ...
    const fetchStock = async () => {
        try {
            ...
            const url = searchQuery
                ? `/api/seller/stock/search?query=${searchQuery}&page=${currentPage}&size=12`
                : `/api/seller/stock? page=${currentPage}&size=12`;
            ...
            {dashboard && (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    <div className="bg-gradient-to-r from-brand-500 to-brand-600 rounded-xl p-6 text-white">
                        <p className="text-brand-100 text-sm">Total Stock Items</p>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-lg mx-4 p-6">
                        ...
                        <div className="flex gap-3 mt-6">
                            ...
                            <button
                                ...
                                className="flex-1 py-3 bg-brand-600 text-white rounded-lg font-medium hover:bg-brand-700 disabled:opacity-50"
                            >
                                Submit for Approval
                            </button>
                        </div>
