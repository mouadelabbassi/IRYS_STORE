        ...
        <div className="p-6">
            ...
            {loading ? (
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-12 text-center">
                    ...
                    <button
                        onClick={handleAddProductClick}
                        className="mt-4 inline-flex items-center px-4 py-2 bg-brand-600 text-white rounded-lg hover:bg-brand-700"
                    >
                        Add Product
                    </button>
                </div>
                        ...
                        >
                            ...
                            <div className="p-4">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <Link
                                        to={`/seller/products/${product.asin}/edit`}
                                        className="flex-1 text-center py-2 bg-brand-600 text-white rounded hover:bg-brand-700 transition text-sm"
                                    >
                                        Edit
                                    </Link>
                                    <button
            ...
            {showAddModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in duration-200">
                        <div className="bg-brand-700 p-6">
                            ...
                            <p className="text-brand-100 mt-2">Choose how you want to add a product</p>
                        </div>
                        ...
                        <div className="p-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <button
                                    ...
                                    className="group p-6 border-2 border-gray-200 dark:border-gray-700 rounded-xl hover:border-brand-500 dark:hover:border-brand-500 transition-all hover:shadow-lg text-left"
                                >
                                    <div className="w-14 h-14 bg-brand-100 dark:bg-brand-900/30 rounded-xl flex items-center justify-center mb-4 group-hover:bg-brand-500 transition-colors">
