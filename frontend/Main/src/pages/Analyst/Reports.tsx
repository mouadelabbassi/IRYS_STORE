...
const Reports:React.FC = () => {
    ...
    const handleExportSales = async () => {
        try {
            ...
            if (exportFormat === 'excel') {
                exportToExcel(enrichedData, 'Irys_Store_Sales_Report', salesColumns);
            } else {
                exportToCSV(enrichedData, 'Irys_Store_Sales_Report', salesColumns);
            }
    ...
    const handleExportProducts = async () => {
        try {
            ...
            if (exportFormat === 'excel') {
                exportToExcel(finalData, 'Irys_Store_Products_Catalog', productColumns);
            } else {
                exportToCSV(finalData, 'Irys_Store_Products_Catalog', productColumns);
            }
    ...
    const handleExportSellers = async () => {
        try {
            ...
            if (exportFormat === 'excel') {
                exportToExcel(finalData, 'Irys_Store_Sellers_Performance', sellerColumns);
            } else {
                exportToCSV(finalData, 'Irys_Store_Sellers_Performance', sellerColumns);
            }
