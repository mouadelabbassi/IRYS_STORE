...
const Home: React.FC = () => {
    ...
    return (
        <>
            <PageMeta
                title="Dashboard - Irys Store Sales Analytics"
                description="Irys Store Sales Analytics Dashboard"
            />
                ...
                {adminStats && (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                        <div className="bg-gradient-to-r from-gray-500 to-gray-600 rounded-xl shadow-lg p-5 text-white">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-3xl font-bold mt-1">{adminStats.totalProducts || 0}</p>
                                </div>
                            ...
                            <p className="text-gray-200 text-xs mt-2">Active catalog</p>
                        </div>
                        <div className="bg-gradient-to-r from-gray-500 to-gray-600 rounded-xl shadow-lg p-5 text-white">
                            <div className="flex items-center justify-between">
                                <div>
                        ...
                        <div className="bg-gradient-to-r from-gray-500 to-gray-600 rounded-xl shadow-lg p-5 text-white">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-gray-100 text-sm font-medium">Today's Orders</p>
                                    <p className="text-3xl font-bold mt-1">{adminStats.todayOrders || 0}</p>
                                </div>
                                <div className="bg-gray-400/30 p-3 rounded-full">
                                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <p className="text-gray-200 text-xs mt-2">Guest checkouts</p>
                        </div>
                        <div className="bg-gradient-to-r from-gray-500 to-gray-600 rounded-xl shadow-lg p-5 text-white">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-gray-100 text-sm font-medium">Today's Revenue</p>
                                    <p className="text-3xl font-bold mt-1">${adminStats.todayRevenue?.toFixed(2) || '0.00'}</p>
                                </div>
                                <div className="bg-gray-400/30 p-3 rounded-full">
                                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <p className="text-gray-200 text-xs mt-2">Confirmed today</p>
                        </div>
                    </div>
                )}
                <div className="mb-6">
